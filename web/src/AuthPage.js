...
const AuthPage = ({ isRegister }) => {
    ...
    const auth = useCallback(async () => {
        ...
        setError(undefined);
        navigate("/portal");
    }, [setError, navigate, isRegister, username, password, confirmPassword]);
    ...
    return (
        <div className={styles.container}>
            <Surface width="300px" stackVertical center>
                ...
                <Input label="Username" fillWidth onChange={setUsername} error={error && error.username} />
                <Input label="Password" fillWidth password onChange={setPassword} error={error && error.password} />
